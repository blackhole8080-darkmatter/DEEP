import{a as O,e,A as r,i as P,g as n,t as N}from"./index-CPHRMAQs.js";import"./ds-panel-D6mYCYD0.js";import"./ds-button-BODBfBLZ.js";var A=Object.defineProperty,F=Object.getOwnPropertyDescriptor,l=(t,s,i,a)=>{for(var c=a>1?void 0:a?F(s,i):s,p=t.length-1,h;p>=0;p--)(h=t[p])&&(c=(a?h(s,i,c):h(c))||c);return a&&c&&A(s,i,c),c};let o=class extends O{constructor(){super(...arguments),this.activePanel="overview",this.domains={},this.loading=!1,this.error="",this.intelItems=[],this.intelLoading=!1,this.cveId="",this.cveResult=null,this.cveSearchKeyword="",this.cveSearchResults=[],this.rfFreq="2437000000",this.rfBw="20000000",this.rfResult=null,this.wifiNetworks=[],this.bleDevices=[],this.physExpr="",this.physVars="",this.physResult=null,this.physSim="pendulum",this.physSimResult=null,this.robotModel="ur5",this.robotAngles="0,0,0,0,0,0",this.robotFkResult=null,this.robotTarget="0.3,0.2,0.5",this.robotIkResult=null,this.sandboxCode=`import sys, platform
...
//# sourceMappingURL=etis-hud-DC1CaZ-m.js.map
