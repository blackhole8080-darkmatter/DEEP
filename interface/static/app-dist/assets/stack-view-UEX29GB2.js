import{i as p,L as h,d as r,e as m,r as c,t as v}from"./index-C-DdVA2t.js";import"./ds-panel-B3ARb1Qv.js";import"./ds-button-DYwwrH6x.js";var u=Object.defineProperty,g=Object.getOwnPropertyDescriptor,d=(a,s,e,t)=>{for(var l=t>1?void 0:t?g(s,e):s,n=a.length-1,i;n>=0;n--)(i=a[n])&&(l=(t?i(s,e,l):i(l))||l);return t&&l&&u(s,e,l),l};let o=class extends p{constructor(){super(...arguments),this.data=null,this.loading=!0,this.hours=24}connectedCallback(){super.connectedCallback(),this.load()}async load(){this.loading=!0;try{this.data=await h(this.hours)}catch(a){this.data={error:String(a)}}this.loading=!1}stat(a,s,e=!1){return r`<div class="stat"><div class="v ${e?"warn":""}">${s??"—"}</div><div class="k">${a}</div></div>`}render(){const a=this.data,s=a==null?void 0:a.llm,e=a==null?void 0:a.tools;return r`
      ...
      <ds-panel heading="Model layer · LLM routing">
        ${s&&s.total_calls?r`
          <div class="stats">
            ...
            ${this.stat("p95",s.p95_ms!=null?`${s.p95_ms}ms`:"—")}
          </div>
          <table>
  ...
  `;d([c()],o.prototype,"data",2);d([c()],o.prototype,"loading",2);d([c()],o.prototype,"hours",2);o=d([v("stack-view")],o);export{o as StackView};
//# sourceMappingURL=stack-view-UEX29GB2.js.map
