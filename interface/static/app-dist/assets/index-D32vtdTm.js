const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/agents-view-CV8eCiQe.js","assets/ds-panel-CCjNIXTY.js","assets/ds-button-CT02qjUn.js","assets/research-view-W_Xdt3rq.js","assets/science-view-Co2_udGC.js","assets/math-CqjoxtmL.js","assets/calc-view-Cp2n9NRU.js","assets/missions-view-DVTGzCNo.js","assets/network-view-Cni-zX3I.js","assets/etis-hud-BXbmNA1a.js","assets/system-monitor-Bb_jEqmG.js","assets/connection-map-Chnc_stt.js","assets/stack-view-UqJJ-XAN.js","assets/audit-view-N4rsOcRM.js","assets/finance-view-BuMs7zhd.js","assets/email-view-H2E0saRl.js","assets/projects-view-CEA4Ld_G.js"])))=>i.map(i=>d[i]);
 ...
 */const S=Symbol("node");var G;(e=>{var t,s,r,i;class o{constructor(c,l={}){Oe(this,s),Ke(this,t);const d=Os(c)[Le];if(this[S]=d,d.wrapper=this,l){const p=l.equals;p&&(d.equal=p),d.watched=l[e.subtle.watched],d.unwatched=l[e.subtle.unwatched]}}get(){if(!(0,e.isState)(this))throw new TypeError("Wrong receiver type for Signal.State.prototype.get");return Ms.call(this[S])}set(c){if(!(0,e.isState)(this))throw new TypeError("Wrong receiver type for Signal.State.prototype.set");if(ys())throw new Error("Writes to signals not permitted during Watcher callback");const l=this[S];Ns(l,c)}}t=S,s=new WeakSet,e.isState=a=>typeof a=="object"&&Xe(s,a),e.State=o;class n{constructor(c,l){Oe(this,i),Ke(this,r);const d=Cs(c)[Le];if(d.consumerAllowSignalWrites=!0,this[S]=d,d.wrapper=this,l){const p=l.equals;p&&(d.equal=p),d.watched=l[e.subtle.watched],d.unwatched=l[e.subtle.unwatched]}}get(){if(!(0,e.isComputed)(this))throw new TypeError("Wrong receiver type for Signal.Computed.prototype.get");return Yt(this[S])}}r=S,i=new WeakSet,e.isComputed=a=>typeof a=="object"&&Xe(i,a),e.Computed=n,(a=>{var c,l,h,d;function p(m){let v,u=null;try{u=de(null),v=m()}finally{de(u)}return v}a.untrack=p;function g(m){var v;if(!(0,e.isComputed)(m)&&!(0,e.isWatcher)(m))throw new TypeError("Called introspectSources without a Computed or Watcher argument");return((v=m[S].producerNode)==null?void 0:v.map(u=>u.wrapper))??[]}a.introspectSources=g;function y(m){var v;if(!(0,e.isComputed)(m)&&!(0,e.isState)(m))throw new TypeError("Called introspectSinks without a Signal argument");return((v=m[S].liveConsumerNode)==null?void 0:v.map(u=>u.wrapper))??[]}a.introspectSinks=y;function M(m){if(!(0,e.isComputed)(m)&&!(0,e.isState)(m))throw new TypeError("Called hasSinks without a Signal argument");const v=m[S].liveConsumerNode;return v?v.length>0:!1}a.hasSinks=M;function N(m){if(!(0,e.isComputed)(m)&&!(0,e.isWatcher)(m))throw new TypeError("Called hasSources without a Computed or Watcher argument");const v=m[S].producerNode;return v?v.length>0:!1}a.hasSources=N;class I{constructor(v){Oe(this,l),Oe(this,h),Ke(this,c);let u=Object.create(lt);u.wrapper=this,u.consumerMarkedDirty=v,u.consumerIsAlwaysLive=!0,u.consumerAllowSignalWrites=!1,u.producerNode=[],this[S]=u}watch(...v){if(!(0,e.isWatcher)(this))throw new TypeError("Called unwatch without Watcher receiver");xt(this,h,d).call(this,v);const u=this[S];u.dirty=!1;const _=de(u);for(const k of v)Ge(k[S]);de(_)}unwatch(...v){if(!(0,e.isWatcher)(this))throw new TypeError("Called unwatch without Watcher receiver");xt(this,h,d).call(this,v);const u=this[S];he(u);for(let _=u.producerNode.length-1;_>=0;_--)if(v.includes(u.producerNode[_].wrapper)){Be(u.producerNode[_],u.producerIndexOfThis[_]);const k=u.producerNode.length-1;if(u.producerNode[_]=u.producerNode[k],u.producerIndexOfThis[_]=u.producerIndexOfThis[k],u.producerNode.length--,u.producerIndexOfThis.length--,u.nextProducerIndex--,_<u.producerNode.length){const R=u.producerIndexOfThis[_],D=u.producerNode[_];dt(D),D.liveConsumerIndexOfThis[R]=_}}}getPending(){if(!(0,e.isWatcher)(this))throw new TypeError("Called getPending without Watcher receiver");return this[S].producerNode.filter(u=>u.dirty).map(u=>u.wrapper)}}c=S,l=new WeakSet,h=new WeakSet,d=function(m){for(const v of m)if(!(0,e.isComputed)(v)&&!(0,e.isState)(v))throw new TypeError("Called watch/unwatch without a Computed or State argument")},e.isWatcher=m=>Xe(l,m),a.Watcher=I;function z(){var m;return(m=bs())==null?void 0:m.wrapper}a.currentComputed=z,a.watched=Symbol("watched"),a.unwatched=Symbol("unwatched")})(e.subtle||(e.subtle={}))})(G||(G={}));/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function di(e,t){return(s,r,i)=>{const o=n=>{var a;return((a=n.renderRoot)==null?void 0:a.querySelector(e))??null};return li(s,r,{get(){return o(this)}})}}class hi{constructor(t="/ws/deep"){this.ws=null,this.handlers=new Set,this.reconnectDelay=1e3,this.maxDelay=15e3,this.closedByUser=!1,this.status="closed";const s=location.protocol==="https:"?"wss":"ws";this.url=`${s}://${location.host}${t}`}connect(){this.closedByUser=!1,this.status="connecting",this.ws=new WebSocket(this.url),this.ws.onopen=()=>{this.status="open",this.reconnectDelay=1e3,this.emit({type:"_socket_open"})},this.ws.onmessage=t=>{try{this.emit(JSON.parse(t.data))}catch{}},this.ws.onclose=()=>{this.status="closed",this.emit({type:"_socket_close"}),this.closedByUser||this.scheduleReconnect()},this.ws.onerror=()=>{var t;return(t=this.ws)==null?void 0:t.close()}}scheduleReconnect(){setTimeout(()=>this.connect(),this.reconnectDelay),this.reconnectDelay=Math.min(this.reconnectDelay*1.6,this.maxDelay)}send(t){var s;((s=this.ws)==null?void 0:s.readyState)===WebSocket.OPEN&&this.ws.send(JSON.stringify(t))}on(t){return this.handlers.add(t),()=>this.handlers.delete(t)}emit(t){for(const s of this.handlers)s(t)}close(){var t;this.closedByUser=!0,(t=this.ws)==null||t.close()}}const We=new hi;let at=1;const je=B("closed"),P=B([]),U=B(!1),be=B([]),pi=B("—"),ui=B(""),Dt=B([]),fi=new Set(["ap_left_proximity","persistent_unknown_ap","device_unusual_time","ap_entered_proximity","new_device_detected","network_flow_recorded","device_joined","security_alert"]),ct=ss(()=>P.get().some(e=>e.streaming));ss(()=>{const e=U.get(),t=ct.get();return je.get()!=="open"?"alert":t?"speaking":e?"thinking":"idle"});function mi(e,t=null){!e.trim()&&!t||(P.set([...P.get(),{id:at++,role:"user",text:e,image:t}]),U.set(!0),be.set([]),We.send({type:"chat",text:e,mode:"auto",image:t}))}function vi(){return P.get().find(e=>e.streaming)}function Lt(e){P.set(P.get().map(t=>t.streaming?{...t,...e}:t))}function gi(e){switch(e.type){case"_socket_open":je.set("open");break;case"_socket_close":je.set("closed");break;case"thinking":U.set(!0);break;case"response_start":U.set(!0);break;case"token":{U.set(!1);const t=String(e.content??"");vi()?P.set(P.get().map(r=>r.streaming?{...r,text:r.text+t}:r)):P.set([...P.get(),{id:at++,role:"ai",text:t,streaming:!0}]);break}case"response_end":{U.set(!1);const t=e;t.model&&pi.set(t.model);const s=be.get();Lt({streaming:!1,model:t.model,latency:t.latency,reasoning:s.length?s:void 0}),be.set([]);break}case"reasoning":{const t=e.step;t&&be.set([...be.get(),t]);break}case"error":{U.set(!1),Lt({streaming:!1}),P.set([...P.get(),{id:at++,role:"ai",text:`⚠ ${e.message??"error"}`}]);break}default:if(ui.set(e.type),fi.has(e.type)){const t=new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",second:"2-digit"}),s=e.type.replace(/_/g," ");Dt.set([{time:t,label:s,type:e.type},...Dt.get()].slice(0,40))}}}let Ut=!1;function bi(){Ut||(Ut=!0,We.on(e=>gi(e)),We.connect())}async function b(e){const t=await fetch(e);if(!t.ok)throw new Error(`${e} → ${t.status}`);return await t.json()}const yi=(e=!1)=>b(`/api/providers/health${e?"?force=true":""}`),er=()=>b("/api/chem/table"),tr=e=>b(`/api/chem/element/${e}`),sr=()=>b("/api/physics/constants"),ir=e=>b("/api/physics/formulas"),rr=()=>b("/api/vitals"),or=()=>b("/api/system/info"),nr=()=>b("/api/network/geo"),ar=e=>b(`/api/investigate?target=${encodeURIComponent(e)}`),cr=(e=24)=>b(`/api/telemetry/summary?hours=${e}`);async function lr(e){return await(await fetch("/api/math/solve",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({query:e})})).json()}async function dr(e){return await(await fetch("/api/science/compute",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({query:e})})).json()}const hr=(e=1)=>b(`/api/finance/summary?months=${e}`),pr=e=>{const t=new URLSearchParams;return e!=null&&e.start&&t.set("start",e.start),e!=null&&e.end&&t.set("end",e.end),e!=null&&e.category&&t.set("category",e.category),t.set("limit",String(e.limit)),b(`/api/finance/transactions?${t}`)},ur=()=>b("/api/finance/budgets"),fr=(e=14)=>b(`/api/finance/bills/upcoming?days=${e}`),mr=e=>b("/api/finance/anomalies");async function vr(e){return(await fetch("/api/finance/transaction",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify(e)})).json()}async function gr(e){return(await fetch("/api/finance/bill",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify(e)})).json()}const br=(e=20)=>b(`/api/email/inbox?limit=${e}`),yr=(e,t=10)=>b(`/api/email/search?q=${encodeURIComponent(e)}&limit=${t}`),_r=()=>b("/api/email/awaiting");async function wr(e){return(await fetch("/api/email/send",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify(e)})).json()}async function xr(e){return(await fetch("/api/missions",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({goal:e})})).json()}const $r=(e,t=20)=>b(`/api/missions${e?`?status=${e}&limit=${t}`:`?limit=${t}`}`);async function Sr(e){return(await fetch(`/api/missions/${e}/cancel`,{method:"POST"})).json()}const kr=()=>b("/api/security/status"),Cr=()=>b("/api/security/devices"),Ar=(e=50)=>b(`/api/security/events?limit=${e}`),Er=(e=24)=>b(`/network/threats?hours=${e}`);async function Pr(e){return(await fetch("/api/security/trust",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({mac:e})})).json()}async function Tr(e){return(await fetch("/api/security/block",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({mac:e})})).json()}async function Or(e){return(await fetch("/api/security/acknowledge",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({event_id:e})})).json()}async function Mr(e){return(await fetch(`/network/scan/${encodeURIComponent(e)}`,{method:"POST"})).json()}const Nr=()=>b("/network/wifi"),Ir=e=>b("/api/network/graph"),Rr=()=>b("/api/network/stats"),Dr=(e,t,s=24)=>b(`/api/network/observations/${encodeURIComponent(e)}?hours=${s}`),Lr=(e,t,s=20)=>b(`/api/network/inferences/${encodeURIComponent(e)}?limit=${s}`);async function Ur(e,t){return(await fetch("/api/network/analyse",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({scope:e,node_id:t})})).json()}var _i=Object.defineProperty,wi=Object.getOwnPropertyDescriptor,as=(e,t,s,r)=>{for(var i=r>1?void 0:r?wi(t,s):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(i=(r?n(t,s,i):n(i))||i);return r&&i&&_i(t,s,i),i};let xi=0,Me=null;function te(e,t="info",s=6e3){Me||(Me=document.createElement("ds-toast-host"),document.body.appendChild(Me)),Me.push({id:++xi,text:e,kind:t},s)}let Fe=class extends E{constructor(){super(...arguments),this.items=[]}push(e,t){this.items=[...this.items,e],setTimeout(()=>this.dismiss(e.id),t)}dismiss(e){this.items=this.items.filter(t=>t.id!==e)}render(){return f`${this.items.map(e=>f`
  ...
  `;vt([x()],Se.prototype,"visible",2);vt([x()],Se.prototype,"progress",2);Se=vt([q("deep-boot")],Se);var Pi=Object.defineProperty,Ti=Object.getOwnPropertyDescriptor,cs=(e,t,s,r)=>{for(var i=r>1?void 0:r?Ti(t,s):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(i=(r?n(t,s,i):n(i))||i);return r&&i&&Pi(t,s,i),i};let Oi=1,qe=class extends E{constructor(){super(...arguments),this.toasts=[]}connectedCallback(){super.connectedCallback(),setTimeout(()=>this._push({title:"DEEP Online",body:"Voice assistant connected and ready.",type:"success"}),1200),setTimeout(()=>this._push({title:"Network Scan Complete",body:"24 devices discovered. 1 unknown flagged.",type:"info",action:{label:"Review →",href:"#network"}}),3500)}_push(e){const t={...e,id:Oi++};this.toasts=[...this.toasts,t],setTimeout(()=>this._remove(t.id),6e3)}_remove(e){const t=this.renderRoot.querySelector(`[data-id="${e}"]`);t&&t.classList.add("out"),setTimeout(()=>{this.toasts=this.toasts.filter(s=>s.id!==e)},350)}render(){return f`
      ${this.toasts.map(e=>f`
...
void main(){
  ...
  `;bt([V()],Ce.prototype,"selected",2);bt([x()],Ce.prototype,"_hover",2);Ce=bt([q("tool-dock")],Ce);var Yi=Object.defineProperty,Ki=Object.getOwnPropertyDescriptor,J=(e,t,s,r)=>{for(var i=r>1?void 0:r?Ki(t,s):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(i=(r?n(t,s,i):n(i))||i);return r&&i&&Yi(t,s,i),i};let F=class extends Kt(E){constructor(){super(...arguments),this.activity=0,this.status="idle",this._openTool="",this._toolView=null,this._loadingTool=!1,this._draft="",this._micLevels=null,this._audioAnalyser=null,this._audioRaf=0,this._onSphereListen=()=>{this._startMic()},this._onSphereCommand=()=>{var t;const e=document.querySelector("command-palette");(t=e==null?void 0:e.toggle)==null||t.call(e)},this._onKey=e=>{e.key==="Escape"&&this._openTool&&this._closeTool()}}connectedCallback(){super.connectedCallback(),window.addEventListener("keydown",this._onKey)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("keydown",this._onKey),this._stopAudio()}async _startMic(){var s;if((s=this._audioAnalyser)!=null&&s.connected)return;if(this._audioAnalyser=new Ui,!await this._audioAnalyser.connectMic()){this._audioAnalyser=null;return}const t=()=>{this._audioAnalyser&&(this._audioAnalyser.update(),this._micLevels={...this._audioAnalyser.levels},this._audioRaf=requestAnimationFrame(t))};this._audioRaf=requestAnimationFrame(t)}_stopAudio(){var e;cancelAnimationFrame(this._audioRaf),(e=this._audioAnalyser)==null||e.destroy(),this._audioAnalyser=null,this._micLevels=null}async _selectTool(e){const t=Wt(e);if(t){this._openTool=e,this.setAttribute("data-focus",""),this._loadingTool=!0,this._toolView=null;try{await t.load(),this._toolView=t.render()}catch{this._toolView=f`<div class="focus-loading">Failed to load ${t.label}.</div>`}this._loadingTool=!1}}_closeTool(){this._openTool="",this._toolView=null,this.removeAttribute("data-focus")}_send(){const e=this._draft.trim();e&&(mi(e),this._draft="")}render(){const e=P.get().slice(-6),t=this._openTool?Wt(this._openTool):null;return f`
      <div class="stage">
        ...
        <div class="dock">
          ...
          ${U.get()?f`<div class="thinking">DEEP is thinking…</div>`:null}
          <div class="composer">
            <input
              .value=${this._draft}
  ...
  `;ds([x()],Ve.prototype,"_hudActive",2);Ve=ds([q("deep-app")],Ve);export{Mr as A,Dt as B,$r as C,xr as D,Sr as E,$ as F,Zi as G,rr as H,or as I,nr as J,ar as K,cr as L,lr as M,dr as N,pe as O,Zs as P,hr as Q,ur as R,fr as S,mr as T,pr as U,vr as V,gr as W,br as X,_r as Y,yr as Z,wr as _,sr as a,ir as b,tr as c,f as d,H as e,er as f,te as g,di as h,E as i,Dr as j,Lr as k,Ur as l,Kt as m,V as n,kr as o,Cr as p,Ar as q,x as r,Er as s,q as t,Nr as u,Ir as v,Rr as w,Pr as x,Tr as y,Or as z};
//# sourceMappingURL=index-D32vtdTm.js.map
