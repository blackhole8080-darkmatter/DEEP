import{a as v,c,b as e,i as f,r as p,t as g}from"./index-TJd2YPHQ.js";import"./ds-panel-Dqkt3HLT.js";var u=Object.defineProperty,h=Object.getOwnPropertyDescriptor,n=(s,r,i,t)=>{for(var a=t>1?void 0:t?h(r,i):r,o=s.length-1,l;o>=0;o--)(l=s[o])&&(a=(t?l(r,i,a):l(a))||a);return t&&a&&u(r,i,a),a};let d=class extends v{constructor(){super(...arguments),this.world=null,this.refreshing=!1}connectedCallback(){super.connectedCallback(),this.load()}async load(){try{this.world=await(await fetch("/api/world")).json()}catch{}}async refresh(){this.refreshing=!0;try{await fetch("/api/world/refresh",{method:"POST"}),await this.load(),c("World model refreshed","success")}catch{c("Refresh failed","danger")}this.refreshing=!1}render(){const s=this.world;return s?e`
    ...
    `:e`<ds-panel heading="Projects"><span class="muted">loading world model…</span></ds-panel>`}};d.styles=f`
  ...
  `;n([p()],d.prototype,"world",2);n([p()],d.prototype,"refreshing",2);d=n([g("projects-view")],d);export{d as ProjectsView};
//# sourceMappingURL=projects-view-D-eabj8u.js.map
