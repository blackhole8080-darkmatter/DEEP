import{i as v,b as r,a as p,r as c,t as g}from"./index-BGH6ox3P.js";import"./ds-panel-B8UnZcCr.js";var f=Object.defineProperty,h=Object.getOwnPropertyDescriptor,l=(s,t,e,i)=>{for(var a=i>1?void 0:i?h(t,e):t,n=s.length-1,o;n>=0;n--)(o=s[n])&&(a=(i?o(t,e,a):o(a))||a);return i&&a&&f(t,e,a),a};let d=class extends v{constructor(){super(...arguments),this.stats=null,this.entries=[]}connectedCallback(){super.connectedCallback(),this.refresh(),this.timer=setInterval(()=>void this.refresh(),8e3)}disconnectedCallback(){super.disconnectedCallback(),clearInterval(this.timer)}async refresh(){fetch("/audit/stats").then(s=>s.json()).then(s=>this.stats=s).catch(()=>{}),fetch("/audit/log?limit=40").then(s=>s.json()).then(s=>this.entries=s.entries??[]).catch(()=>{})}render(){const s=this.stats;return r`
      ${s?r`
...
//# sourceMappingURL=audit-view-pRCm_GpB.js.map
