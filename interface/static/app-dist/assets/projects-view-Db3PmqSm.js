import{a as v,y as c,e,i as g,g as p,t as f}from"./index-CPHRMAQs.js";import"./ds-panel-D6mYCYD0.js";import"./ds-button-BODBfBLZ.js";var u=Object.defineProperty,h=Object.getOwnPropertyDescriptor,n=(s,r,i,t)=>{for(var a=t>1?void 0:t?h(r,i):r,o=s.length-1,l;o>=0;o--)(l=s[o])&&(a=(t?l(r,i,a):l(a))||a);return t&&a&&u(r,i,a),a};let d=class extends v{constructor(){super(...arguments),this.world=null,this.refreshing=!1}connectedCallback(){super.connectedCallback(),this.load()}async load(){try{this.world=await(await fetch("/api/world")).json()}catch{}}async refresh(){this.refreshing=!0;try{await fetch("/api/world/refresh",{method:"POST"}),await this.load(),c("World model refreshed","success")}catch{c("Refresh failed","danger")}this.refreshing=!1}render(){const s=this.world;return s?e`
...
//# sourceMappingURL=projects-view-Db3PmqSm.js.map
