import{a as g,c as v,b as d,i as h,r as l,t as f}from"./index-TJd2YPHQ.js";import"./ds-panel-Dqkt3HLT.js";var m=Object.defineProperty,u=Object.getOwnPropertyDescriptor,c=(s,e,a,n)=>{for(var t=n>1?void 0:n?u(e,a):e,o=s.length-1,i;o>=0;o--)(i=s[o])&&(t=(n?i(e,a,t):i(t))||t);return n&&t&&m(e,a,t),t};let r=class extends g{constructor(){super(...arguments),this.briefing=null,this.stats=null,this.papers=null,this.speaking=!1}connectedCallback(){super.connectedCallback(),this.load()}async load(){fetch("/api/briefing").then(s=>s.json()).then(s=>this.briefing=s).catch(()=>{}),fetch("/api/research/stats").then(s=>s.json()).then(s=>this.stats=s).catch(()=>{}),fetch("/knowledge/status").then(s=>s.json()).then(s=>this.papers=s).catch(()=>{})}async speak(){this.speaking=!0;try{await fetch("/api/briefing/speak",{method:"POST"}),v("Speaking briefing…","info")}catch{v("TTS unavailable","danger")}setTimeout(()=>this.speaking=!1,1500)}render(){var t,o;const s=this.briefing,e=this.stats,a=this.papers,n=a&&Object.values(a.papers_by_domain).reduce((i,p)=>i+p,0)||1;return d`
  ...
  `;c([l()],r.prototype,"briefing",2);c([l()],r.prototype,"stats",2);c([l()],r.prototype,"papers",2);c([l()],r.prototype,"speaking",2);r=c([f("research-view")],r);export{r as ResearchView};
//# sourceMappingURL=research-view-Di2q1iaQ.js.map
