import{i as v,g as c,d as e,e as g,r as p,t as f}from"./index-BZpHEIVQ.js";import"./ds-panel-B0Coku7q.js";import"./ds-button-X_d22ss4.js";var u=Object.defineProperty,h=Object.getOwnPropertyDescriptor,n=(s,r,i,t)=>{for(var a=t>1?void 0:t?h(r,i):r,o=s.length-1,l;o>=0;o--)(l=s[o])&&(a=(t?l(r,i,a):l(a))||a);return t&&a&&u(r,i,a),a};let d=class extends v{constructor(){super(...arguments),this.world=null,this.refreshing=!1}connectedCallback(){super.connectedCallback(),this.load()}async load(){try{this.world=await(await fetch("/api/world")).json()}catch{}}async refresh(){this.refreshing=!0;try{await fetch("/api/world/refresh",{method:"POST"}),await this.load(),c("World model refreshed","success")}catch{c("Refresh failed","danger")}this.refreshing=!1}render(){const s=this.world;return s?e`
...
//# sourceMappingURL=projects-view-BWOaguFa.js.map
